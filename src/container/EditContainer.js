...
import BackComponent from '../components/BackComponets';
import { connect } from 'react-redux';
import FormComponent from '../components/FormComponent';
import { getUsersDetail, puUserUpdate } from '../actions/userAction';
...
class EditUserContainer extends Component {
  ...
  handleSubmit(data) {
    this.props.dispatch(puUserUpdate(data, this.props.match.params.id));
  }
